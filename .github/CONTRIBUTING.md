...
1. **Fork the repository:**
   - Visit the [repository](https://github.com/Beltiston/Chronos)
     and click on the `Fork` button.
2. **Clone your fork:**

   ```bash
   git clone https://github.com/Beltiston/Chronos.git
   ```
...
- Check if the issue already exists in the [issues list](https://github.com/Beltiston/Chronos/issues).
...
- Check if your feature idea is already being discussed in the
  [issues list](https://github.com/orgs/Beltiston/discussions/categories/ideas).
...
6. **Open a pull request:**
   - Go to the [Pull Requests](https://github.com/Beltiston/Chronos/pulls)
     section.
...
> [!NOTE]
> First commit changes, then run `pnpm run build`,
...
the same license as this repository ([GNU LESSER GENERAL PUBLIC LICENSE](../LICENSE)).
